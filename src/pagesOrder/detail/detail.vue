...
const pageInstance = pages[pages.length - 1] as any // 获取当前页面实例
...
//获取订单详情
async function getMemberOrderByIdData() {
  const resp = await getMemberOrderByIdAPI(query.id)
  order.value = resp.result
}
onLoad(() => {
